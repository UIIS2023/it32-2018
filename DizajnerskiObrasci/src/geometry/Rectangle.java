...
public class Rectangle extends SurfaceShape {
	...
	public boolean contains(Point p) {
		if (this.getUpperLeftPoint().getX() <= p.getX() && upperLeftPoint.getY() <= p.getY()
				&& p.getX() <= upperLeftPoint.getX() + width && p.getY() <= this.getUpperLeftPoint().getY() + height) {
			return true;
		} else {
			return false;
		}
	...
	public String toString() {
		return "Rectangle [(" + upperLeftPoint.getX() + ", " + upperLeftPoint.getY() + "), Width (" + width
				+ "), Height (" + height + "), OutlineColor (" + getColor().getRGB() + " )" + ", InnerColor ("
